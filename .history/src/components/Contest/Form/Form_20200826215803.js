...
export default function Form(){
  ...
  const [displayError, setDisplayError] = useSt
      ...
      <form class="wrapper" onSubmit={handleSubmit}>
        ...
        <div class="contact-form">
          <div class="input-fields helper-container">
            <small className="text-danger helper-text-one">Error</small>
            <input
              ref={inputRef}
              name="firstname"
              type="text"
            ...
            />
            <small className="text-danger helper-text-two">Error</small>
            ...
            />
            <small className="text-danger helper-text-three">Error</small>
          ...
          <div class="msg helper-container-msg">
            ...
            />
            <small className="text-danger helper-text-four">Error</small>
