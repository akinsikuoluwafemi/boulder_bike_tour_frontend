        ...
        <form class="wrapper" onSubmit={handleSubmit}>
            ...
            <div class="contact-form">
                <div class="input-fields">
                    ...
                    <input ref={inputRef} name="lastname" type="text" class="input" placeholder="Last Name" required value={last_name} onChange={handleLastName}/>
                    <input ref={inputRef} name="email" type="email" class="input" placeholder="Email Address" required value={email} onChange={handleEmail} />
                </div>
                <div class="msg">
