      ...
      <form class="wrapper" onSubmit={handleSubmit}>
        ...
        <div class="contact-form">
          <div class="input-fields helper-container">
            ...
            >
              {alert === 'error'?displayFirstNameErr(firstNameErr) : null}
            </small>
            <input
              ref={inputRef}
              name="firstname"
            ...
            >
              {displayLastNameErr(lastNameErr)}
            </small>
