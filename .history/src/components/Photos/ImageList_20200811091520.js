...
const ImageList = () =>
{
    ...
    return (
        <div className="py-4">
            ...
            <div className="container">
                <div className="m-auto image-list align="center">
            ...
            {totalPages < page ? <div align="center">There are no more pictures to load</div> :
                ...
                <div onClick={loadPictures} className="button_cont" align="center"><a class="example_d"  rel="nofollow noopener">Load More</a></div>
            }
        </div>
    )
