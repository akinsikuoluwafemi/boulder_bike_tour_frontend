...
const ImageList = () =>{
    ...
    let [loading, setLoading] = useState(truw);
            ...
            <div className="container py-5">
                ...
                <div align="center">
                    ...
                    {totalPages < page ? <div align="center">There are no more pictures to load</div> :
                        ...
                        <div onClick={() => LoadMorePictures()} className="button_cont mt-5" align="center"><a class="example_d" rel="nofollow noopener">Load More</a></div>
                    }
                </div>
            </div>
