        ...
        <div>
            ...
            <div className=" my-5">
                <section className="container">
                    ...
                    <div className="row">
                        <Winners name="Micah Thomas" text="Some quick example text to build on the card title and make up the bulk of the card's content." contact="Bo" image={winnerOne} />
