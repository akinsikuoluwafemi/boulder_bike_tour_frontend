                    ...
                    <div className="footer-container">
                        ...
                        <div className="footer-content">
                            ...
                            <ul className="footer-list">
                                <li className="footer-list-item pb-2"><a style={{ color: '#777' }} href="#htt">All Boulder Bike tours</a></li>
                                <li className="footer-list-item pb-2"><a style={{ color: '#777' }} href="#htt">Summer races</a></li>
                                <li className="footer-list-item pb-2"><a style={{ color: '#777' }} href="#htt">Winter races</a></li>
                                <li className="footer-list-item pb-2"><a style={{ color: '#777' }} href="#htt">Youth biking races</a></li>
                                <li className="footer-list-item"><a style={{ color: '#777' }} href="#htt">Results</a></li>
                            </ul>
                        </div>
