                ...
                <div className="container">
                    <div className="footer-container">
                        ...
                        <div className="footer-content">
                            ...
                            <ul className="footer-list">
                                <li className="footer-list-item pb-2"><a style={{ color: '#fff' }} href="#">Media Resources</a></li>
                                <li className="footer-list-item pb-2"><a style={{ color: '#fff' }} href="#">Latest News</a></li>
                                <li className="footer-list-item pb-2"><a style={{ color: '#fff' }} href="#">Key event calender</a></li>
