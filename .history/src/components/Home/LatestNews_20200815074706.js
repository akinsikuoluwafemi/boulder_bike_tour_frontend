                ...
                <Slider {...settings}>
                    ...
                    <figure className="figure-container px-2">
                        ...
                        <figcaption className="figure-caption">
                            <p className="h6 caption-text font-weight-bold">Racing in the summer at B</p>
                    ...
                    <figure className="figure-container px-2">
                        ...
                        <figcaption className="figure-caption">
                            <p className="h6 caption-text font-weight-bold">Catch out youths from a very young age...</p>
                            <p className="date">08 AUG 2020</p>
                        </figcaption>
                    </figure>
