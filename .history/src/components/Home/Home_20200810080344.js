                    ...
                    <div className="footer-container">
                        <div className="footer-content">
                            ...
                            <ul className="footer-list">
                                <li className="footer-list-item pb-2"><a style={{ color: '#B1B1B1'}} href="#">All Boulder Bike tours</a></li>
                                <li className="footer-list-item pb-2"><a href="#">Summer races</a></li>
                                <li className="footer-list-item pb-2"><a href="#">Winter races</a></li>
                                <li className="footer-list-item pb-2"><a href="#">Youth biking races</a></li>
