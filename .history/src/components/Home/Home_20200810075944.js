                ...
                <div className="container">
                    <div className="footer-container">
                        <div className="footer-content">
                            <h6 className="footer-heading-text ">Boulder Bike Tour</h6>
                            <ul className="footer-list">
                                <li className="footer-list-item"><a href="#">All Boulder Bike tours</a></li>
                                <li className="footer-list-item"><a href="#">Summer races</a></li>
                                <li className="footer-list-item"><a href="#">Winter races</a></li>
                                <li className="footer-list-item"><a href="#">Youth biking races</a></li>
                                <li className="footer-list-item"><a href="#">Results</a></li>
                            </ul>
                        </div>
