...
background-color: #666666;
    ...
    color: transparent;
    text-shadow: rgba(255,255,255,0.5) 0px 3px 3px; hero-intro-text">You're all invited to Our upcoming Bike tour which happens once every decade. Taking place at colorado at the foot of the Rocky Mountains where we host Bikers from all over the globe. Starts on 24 July</p>
