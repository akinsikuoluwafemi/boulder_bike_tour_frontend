                    ...
                    <div className="slide-container">
                        <figure className="figure-container">
                            <div className="fig-image">
                                <span className=" tag text-white font-weight-bold">OLYMPIC NEWS</span>                            

                            </div>
                            <figcaption className="figure-caption">
                                <p className="h6 font-weight-bold">Safer Sport day to reinforce the utmost</p>
                        ...
                        <figure className="figure-container">
                            <div className="fig-image">
                                <span className="tag text-white">OLYMPIC NEWS</span>
                            
                            </div>
                            <figcaption className="figure-caption">
                                <p className="h6 font-weight-bold font-weight-bold">Safer Sport day to reinforce the utmost</p>
                                <p className="date">08 AUG 2020</p>
                            </figcaption>
                        </figure>
